  ...
  return (
    <div className="grid grid-cols-1 xl:grid-cols-12 gap-8">
      <div className="xl:col-span-8 flex flex-col gap-8">
        <section className="bg-white/40 dark:bg-black/40 backdrop-blur-xl border border-black/10 dark:border-white/10 rounded-xl flex flex-col overflow-hidden">
          ...
          <div className="p-6 md:p-8 space-y-6">
            ...
            <div className="space-y-2">
              <label className="block text-[11px] font-mono font-bold uppercase tracking-widest text-black/40 dark:text-white/40">URL to Program</label>
              <div className="p-3 bg-[#f9f9f9] dark:bg-[#1a1a1a] border border-black/10 dark:border-white/10 rounded-xl font-mono text-sm break-all">
                {profileUrl}
              </div>
            </div>

            <div className="flex flex-col items-center justify-center p-8 border-2 border-dashed border-black/10 dark:border-white/10 rounded-2xl bg-[#f9f9f9] dark:bg-[#1a1a1a]">
              {status === 'idle' && (
                <>
                  ...
                  <p className="text-black/40 dark:text-white/40 text-sm text-center max-w-md mb-6">
              ...
              {status === 'scanning' && (
                <>
                  <div className="relative mb-6">
                    <div className="absolute inset-0 border-4 border-black/20 dark:border-black/20 dark:border-white/20 rounded-full animate-ping"></div>
                    <div className="w-20 h-20 bg-blue-500 text-black dark:text-white rounded-full flex items-center justify-center shadow-lg relative z-10 animate-pulse">
                  ...
                  <button 
                    ...
                    className="bg-white/40 dark:bg-black/40 backdrop-blur-xl border border-black/10 dark:border-white/10 px-6 py-2 rounded-2xl font-bold text-sm hover:bg-[#f9f9f9] dark:hover:bg-[#222]"
                  >
                    Cancel
                  </button>
                </>
              ...
              {status === 'success' && (
                <>
                  <div className="w-16 h-16 bg-green-500 text-black dark:text-white rounded-full flex items-center justify-center mb-4 shadow-lg">
              ...
              {status === 'error' && (
                <>
                  <div className="w-16 h-16 bg-red-500 text-black dark:text-white rounded-full flex items-center justify-center mb-4 shadow-lg">
      ...
      <div className="xl:col-span-4 flex flex-col gap-6">
        <div className="bg-white/40 dark:bg-black/40 backdrop-blur-xl border border-black/10 dark:border-white/10 p-5 rounded-xl">
