  ...
  if (senderMode) {
    ...
    return (
      <div className="space-y-6 animate-in fade-in">
        <div className="flex items-center justify-between bg-white dark:bg-[#111] p-4 rounded-md shadow-sm border border-[#cfc4c5] dark:border-[#333]">
          <div className="flex items-center gap-3">
            <button onClick={() => setSenderMode(false)} className="px-4 py-2 border border-[#cfc4c5] dark:border-[#333] rounded-sm text-sm font-bold hover:bg-gray-50 dark:hover:bg-[#222]">Back to Setup</button>
        ...
        <div className="bg-white dark:bg-[#111] rounded-md shadow-sm border border-[#cfc4c5] dark:border-[#333] overflow-hidden">
                  ...
                  <tr key={lead.id} className={isSent ? "opacity-50" : ""}>
                    ...
                    <td className="p-4 text-right">
                      <button 
                        ...
                        className="bg-[#25D366] hover:bg-[#20b858] disabled:opacity-50 text-white font-bold py-2 px-4 rounded-sm transition-colors inline-flex items-center gap-2 text-xs"
                      >
          ...
          {/* Pagination */}
          <div className="p-4 border-t border-[#cfc4c5] dark:border-[#333] flex justify-between items-center bg-gray-50 dark:bg-[#1a1a1a]">
            <button 
              onClick={() => setCurrentPage(p => Math.max(1, p - 1))}
              disabled={currentPage === 1}
              className="px-4 py-2 bg-white dark:bg-[#111] border border-[#cfc4c5] dark:border-[#333] rounded-sm disabled:opacity-50 text-sm font-bold"
            >
              Previous
            </button>
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-3 gap-4">
          <div className="bg-white dark:bg-[#111] border border-[#cfc4c5] dark:border-[#333] p-4 rounded-md text-center">
            <div className="text-2xl font-mono font-bold mb-1">{stats.totalLeads}</div>
            <div className="text-[10px] text-[#7e7576] uppercase font-bold tracking-wider">Total Leads</div>
          </div>
          <div className="bg-white dark:bg-[#111] border border-[#cfc4c5] dark:border-[#333] p-4 rounded-md text-center">
            <div className="text-2xl font-mono font-bold mb-1 text-blue-500">{stats.sent7Days}</div>
            <div className="text-[10px] text-[#7e7576] uppercase font-bold tracking-wider">Sent (7 Days)</div>
          </div>
          <div className="bg-white dark:bg-[#111] border border-[#cfc4c5] dark:border-[#333] p-4 rounded-md text-center relative overflow-hidden group">
            ...
            <div className="relative z-10">
              ...
              <div className="text-[10px] text-[#7e7576] uppercase font-bold tracking-wider">Sends Left / Hr</div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-[#111] p-6 rounded-md shadow-sm border border-[#cfc4c5] dark:border-[#333]">
          <div className="flex justify-between items-center mb-6">
            ...
            <button onClick={fetchData} className="p-2 hover:bg-gray-100 dark:hover:bg-[#222] rounded-md transition-colors"><RefreshCw className="w-4 h-4" /></button>
          </div>

          <div className="space-y-6">
            {/* Send Type */}
            <div>
              <label className="block font-mono text-[11px] font-bold text-[#4c4546] dark:text-[#a0a0a0] uppercase mb-2">Send Type</label>
            ...
            {sendType === 'post' && (
              <div>
                <label className="block font-mono text-[11px] font-bold text-[#4c4546] dark:text-[#a0a0a0] uppercase mb-2">Select Post</label>
                <select 
                  className="w-full px-3 py-2 border border-[#cfc4c5] dark:border-[#333] rounded-sm text-[13px] bg-transparent"
            ...
            {sendType === 'custom' && (
              <div>
                <label className="block font-mono text-[11px] font-bold text-[#4c4546] dark:text-[#a0a0a0] uppercase mb-2">Message Template (Use {`{Name}`})</label>
                <textarea 
                  className="w-full px-3 py-2 border border-[#cfc4c5] dark:border-[#333] rounded-sm text-[13px] bg-transparent h-32"
                  value={customMessage}
            ...
            <div className="pt-4 border-t border-[#cfc4c5] dark:border-[#333]">
              <label className="block font-mono text-[11px] font-bold text-[#4c4546] dark:text-[#a0a0a0] uppercase mb-2 flex items-center gap-1">
              ...
              <div className="flex flex-col gap-3">
                ...
                {audienceFilter === 'city' && (
                  <select className="w-full px-3 py-2 border border-[#cfc4c5] dark:border-[#333] rounded-sm text-[13px] bg-transparent" value={filterValue} onChange={e => setFilterValue(e.target.value)}>
      ...
      <div className="bg-white dark:bg-[#111] p-6 rounded-md shadow-sm border border-[#cfc4c5] dark:border-[#333] flex flex-col">
        <h3 className="font-sans font-bold text-lg mb-6 flex items-center gap-2">
          Message Preview
        </h3>
        
        <div className="flex-1 bg-[#e5ddd5] dark:bg-[#0b141a] p-4 rounded-md relative overflow-hidden flex flex-col justify-end min-h-[300px]">
        ...
        <div className="mt-6 pt-4 border-t border-[#cfc4c5] dark:border-[#333]">
          <div className="flex items-start gap-2 text-xs text-[#7e7576] mb-4">
          ...
          <button 
            ...
            className="w-full bg-black dark:bg-white text-white dark:text-black hover:bg-gray-800 dark:hover:bg-gray-200 disabled:opacity-50 font-bold py-3 rounded-md transition-colors flex items-center justify-center gap-2"
          >
